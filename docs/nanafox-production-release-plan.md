...
>
> 历史定位：本文件只记录 2026-08-22 的静态 ToC 首次发布，当时明确不部署 Sub2API。2026-08-25 起包含模板、管理端、独立数据库表和 scoped session 的当前生产方案，以 `docs/nanafox-image-creation-v1-plan.md` 为唯一实施依据；不得把本文件的“不部署 Sub2API”继续套用到后续版本。
>
