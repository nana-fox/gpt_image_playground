...
async function migrate(pool) {
  ...
  try {
    ...
    `)
    for (const migration of ['001_initial.sql', '002_admin_operations.sql', '003_payments.sql', '004_payment_channel.sql', '005_auth_rate_limits.sql', '006_artwork_retention.sql', '007_inspirations.sql', '008_generation_reliability.sql', '009_payment_providers.sql']) {
